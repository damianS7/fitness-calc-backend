package com.fitnesscalc.auth;

import com.fitnesscalc.config.SecurityConstants;
import com.fitnesscalc.utils.JwtUtil;
...
public class AuthorizationFilter extends BasicAuthenticationFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        if (request.getParameter("token") != null) {
            token = SecurityConstants.TOKEN_BEARER_PREFIX + request.getParameter("token");
        }
        ...
        if (token == null || !token.startsWith(SecurityConstants.TOKEN_BEARER_PREFIX)) {
